...
public class CurrencyPair implements Comparable<CurrencyPair>, Serializable {
  ...
  public static final CurrencyPair BCH_MXN = new CurrencyPair(Currency.BCH, Currency.MXN);
  ...
  public static final CurrencyPair ETH_MXN = new CurrencyPair(Currency.ETH, Currency.MXN);
  ...
  public static final CurrencyPair XRP_MXN = new CurrencyPair(Currency.XRP, Currency.MXN);
  ...
  public static final CurrencyPair LTC_MXN = new CurrencyPair(Currency.LTC, Currency.MXN);
